...
HTMLHelper::_('script', 'com_pp/task_type.js', array('version' => 'auto', 'relative' => true));
?>
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_PP_TITLE_TAB_GENERAL')); ?>
                <div class="row-fluid">
                    <div class="span6">
