...
class PpModelObjects extends ListModel
{
    ...
    protected function _getListQuery()
    {
        ...
        $query
            ->select("o.id, o.title, o.ordering")
            ->from("#__mkv_pp_objects o");
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            ...
            $url = JRoute::_("index.php?option={$this->option}&amp;task=object.edit&amp;id={$item->id}");
    ...
    protected function populateState($ordering = 'o.ordering', $direction = 'asc')
    {
